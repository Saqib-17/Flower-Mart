    ...
    <section className="py-12">
      <div className="section-container">
        <h2 className="text-3xl text-center font-semibold">
          <span className="text-brand font-display text-[50px] leading-tight font-bold ">Our</span > <span className="font-display text-[50px] leading-tight font-bold ">Plants</span >
        </h2>
